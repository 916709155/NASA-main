...
parser.add_argument('--epochs', type=int, default=500, help='Number of epochs to train.') #epoch
parser.add_argument('--hidden', type=int, default=32, help='Number of hidden units.') #隐藏层单元
parser.add_argument('--dropout', type=float, default=0.5, help='Dropout rate') #脱出率
parser.add_argument('--alpha', type=float, default=0.3, help='loss hyperparameter') #正则化参数
